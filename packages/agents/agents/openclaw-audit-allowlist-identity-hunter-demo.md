...
The published zalouser writeup passes this gate cleanly because:
...
Known-broken (validated, expect or have GHSAs): `msteams`, `matrix`.
Audit these first to ground-truth your understanding of the Layer-2
shape, then sweep the rest.
...
`mattermost`, `feishu`, `slack` — they support
