      ...
      <main className="max-w-4xl mx-auto px-6 pt-8 pb-24">
        ...
        <div className="rounded-xl border border-bg-border bg-bg-panel/40 p-6 md:p-8 mb-6">
          <div className="flex flex-wrap items-center gap-2 mb-4">
            ...
            <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-mono uppercase tracking-wider border border-bg-border bg-bg/40 text-cyan">
              {finding.vulnSlug}
            </span>
            <span className="inline-flex items-center gap-1 text-[10px] font-mono text-ink-dim ml-auto">
        ...
        {finding.cvss && (
          <Section title="CVSS 3.1">
            <div className="font-mono text-xs text-cyan break-all mb-3">
              {finding.cvss.vector}
            </div>
            <div className="text-sm text-ink mb-3">
              Base score:{' '}
              <span className="text-amber font-semibold">
                {finding.cvss.baseScore.toFixed(1)}
              </span>{' '}
